...
public class UsersController extends BaseController {
	...
	public Map<String, Object> insertUsers(@RequestBody String jsonStr) {
		...
		users.setClazzid(obj.getString("clazzid")); // 为所在班级赋值
		users.setContact(obj.getString("contact")); // 为联系方式赋值
		users.setAddress(obj.getString("address")); // 为家庭住址赋值
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> queryUsers(@RequestParam(defaultValue = "1") Integer page,
