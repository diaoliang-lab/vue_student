...
public class ArticleController extends BaseController {
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> getArticleByPage(@RequestParam(defaultValue = "1") Integer page,
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> queryArticle(@RequestParam(defaultValue = "1") Integer page,
