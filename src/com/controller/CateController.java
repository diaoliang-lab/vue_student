...
public class CateController extends BaseController {
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> getCateByPage(@RequestParam(defaultValue = "1") Integer page,
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> queryCate(@RequestParam(defaultValue = "1") Integer page,
