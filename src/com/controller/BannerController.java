...
public class BannerController extends BaseController {
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> getBannerByPage(@RequestParam(defaultValue = "1") Integer page,
	...
	@ResponseBody // 将java对象转为json格式的数据返回
	public Map<String, Object> queryBanner(@RequestParam(defaultValue = "1") Integer page,
